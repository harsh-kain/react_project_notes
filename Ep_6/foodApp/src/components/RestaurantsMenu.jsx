...
const RestaurantsMenu = () => {
    ...
    let { name, cloudinaryImageId, avgRatingString, locality, areaName, cuisines, availability, costForTwoMessage, feeDetails } = resInfo?.cards[0]?.card?.card?.info || {};
            ...
            <section className="text-gray-700 body-font overflow-hidden bg-white">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex justify-center flex-wrap">
                        <img
                            alt="ecommerce"
                            className="w-1/2 object-cover object-center rounded border border-gray-200"
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="leading-relaxed">
                                ...
                                <b>Details </b> : {feeDetails.message} ISD <br />
